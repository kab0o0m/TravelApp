    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Home">
          ...
          <Stack.Screen name="HomeFeatured1" component={HomeFeatured1} options={{ headerShown: false }} />
          <Stack.Screen name="HomeFeatured2" component={HomeFeatured2} options={{ headerShown: false }} />
          <Stack.Screen name="HomeFeatured3" component={HomeFeatured3} options={{ headerShown: false }} />
          <Stack.Screen name="HomeFeatured4" component={HomeFeatured4} options={{ headerShown: false }} />
          ...
          <Stack.Screen name="PlannerAddDestination" component={PlannerAddDestination} options={{ headerShown: false }} />
          <Stack.Screen name="PlannerItinerary" component={PlannerItinerary} options={{ headerShown: false }}/>
          <Stack.Screen name="PlannerOverview" component={PlannerOverview} options={{ headerShown: false }} />
