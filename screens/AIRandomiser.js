...
import { View, Text, StyleSheet, Image, Dimensions, ActivityIndicator, TouchableOpacity, ImageBackground, Animated, Alert } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.bottomContainer}>
                ...
                {showMessage && (
                    <ImageBackground source={require('../assets/MessageBox.png')} style={styles.messageContainer}>
...
const styles = StyleSheet.create({
    ...
    buttonContainer: { position: 'absolute', width: 214, height: 47, bottom: 230, paddingVertical: 10, paddingHorizontal: 30, backgroundColor: '#006D77', borderRadius: 28, justifyContent: 'center', alignItems: 'center' },
    shuffleButton: { justifyContent: 'center', alignItems: 'center' },
    shuffleText: { color: 'white', fontSize: 20, fontFamily: 'Nunito_700Bold' },
    messageContainer: { position: 'absolute', width: 352, height: 460.98, borderRadius: 24, justifyContent: 'space-evenly', alignItems: 'center', top: -325, left: screenWidth / 2 - 176, zIndex: 2 },
    messageText: { top: -15, width: 300, fontSize: 20, fontFamily: 'Nunito_800ExtraBold', color: '#006D77', textAlign: 'center' },
    destinationText: { top: -50, width: 300, fontSize: 36, fontFamily: 'Nunito_900Black', color: '#006D77', textAlign: 'center' },
    activityHeader: { top: -70, width: 300, fontSize: 20, fontFamily: 'Nunito_800ExtraBold', color: '#006D77', textAlign: 'center' },
    activityContainer: { alignItems: 'center' },
    activityItem: { marginBottom: -10 },
    activityText: { top: -100, width: 300, fontSize: 24, fontFamily: 'Nunito_900Black', color: '#006D77', textAlign: 'center', marginBottom: 10 },
    buttonRow: { flexDirection: 'row', justifyContent: 'space-between', width: '95%', paddingHorizontal: 50, position: 'absolute', bottom: 75, gap: 60 },
    cancelButton: { justifyContent: 'center', alignItems: 'center' },
    cancelText: { color: '#A0A0A0', fontSize: 16, fontFamily: 'Nunito_700Bold', textDecorationLine: "underline" },
    addToPlannerButton: { backgroundColor: '#F47966', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 28, justifyContent: 'center', alignItems: 'center' },
