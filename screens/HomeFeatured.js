...
const HomeFeatured = () => {
  ...
  const handleWebsitePress = () => {
    const url = 'https://www.rwsentosa.com/en/attractions/universal-studios-singapore#:~:text=Experience%20the%20thrill%20of%20Hollywood,%20New%20York,%20Sci-Fi%20City,%20Ancient';
  ...
  const handleKlookPress = () => {
    const url = 'https://www.klook.com/en-SG/activity/117-universal-studios-singapore/';
    Linking.openURL(url).catch(err => console.error("Failed to open Klook URL:", err));
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.featuredContainer}>
        <Image source={require('../assets/USSimage.png')} style={styles.featuredImage} />
        <LinearGradient
          colors={['#FFFFFF00', 'rgba(0, 0, 0, 0.4)']} // Linear gradient from white to black with 40% opacity
          style={styles.featuredOverlay}
        />
        <Text style={styles.featuredTitle}>Universal Studios Singapore (USS)</Text>
      </View>

      <View style={styles.bookNowContainer}>
        <TouchableOpacity style={styles.bookNowButton} onPress={handleKlookPress}>
      ...
      <Text style={styles.description}>
        USS offers thrilling rides, live shows, and attractions based on your favourite movies and TV shows. Perfect for families and adventure-seekers!
      </Text>
    ...
    <View style={styles.infoContainer}>
      ...
      <View style={styles.infoContainer}>
        <Image source={require('../assets/WebsiteIcon.png')} style={styles.icon} />
